...
class Train(object):
    ...
    def __init__(self, model, pickle_f_custom_freq=None, custom_eval_func=None):
        ...
        :param train_set: Tuple containing either input and target, or only input.
        :param test_set: Tuple containing either input and target, or only input.
        :param validation_set: Tuple containing either input and target, or only input.
        :param pickle: Boolean value deciding whether the model shall be pickled.
        :param pickle_f_custom_freq: The number of epochs between each serialization, plotting etc.
        :param custom_eval_func: The visualisation function taking (model, output_path) as arguments.
        """
        self.model = model
        self.logger = None
        self.init_logging()
    ...
    def init_logging(self):
        """
        Initiate the logging, so that all the training output will be saved in a .log file on disc.
        """
